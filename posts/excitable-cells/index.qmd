...
In the simulation below, cells have different refractory periods. 

<div class="simcontainer">
<canvas id="sim_afib" width="600" height="400"></canvas>
<div class="slidercontainer">
  <input type="range" min="10" max="60" value="20" class="slider" id="slider_afib_scale">
  <input type="range" min="0" max="200" value="40" class="slider" id="slider_afib_gain">
