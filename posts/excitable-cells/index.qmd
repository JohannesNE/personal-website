...
In the simulation below, cells in to low left corner has a longer refractory period.
...
> 👆️ Try setting of a few ectopic beats in the simulation below, and see if you can initiate one or more reentrant loops. 
  ...
  💡 Make the system more unstable by changing the **scale** (with high scale, nearby cells have similar refractory times) and **range** (overall range of refractory times in the system). High range especially makes the system unstable.  

  💡 Depolarize to system to easily see the variation in refractory time.

<div class="simcontainer">
<canvas id="sim_afib" width="600" height="400"></canvas>
<div class="slidercontainer">
